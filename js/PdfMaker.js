app.service('PdfMaker', [function() {
    ...
    this.createChart = function(personalDetails,dob, age, fy, cses, nra, tfp, beforeTTR, nrp, thp, resultWithoutSS, resultWithSS, needSS, favourableSS, favourableDD, toggleNeeded) {
        ...
        var columnsP1 = [
            { title: "Optimisation of Transition to Retirement Pension", dataKey: "info" },
        ];
        ...
        var rowsP3 = [
            { "info": "1) Salary indicated here does not include any superannuation guarantee contribution." },
            { "info": "2) It is assumed that the member's superannuation balance is fully in accumulation phase before using this calculator." },
            { "info": "3) It is assumed that at least the minimum take-home(after salary sacrifice and tax) wage is required\nby the member." },
            { "info": "4) The pension drawdown percentage is within 4% to 10%." },
            { "info": "5) It is assumed that the contribution will be made in the middle of the financial year." },
            { "info": "6) It is assumed that the tax free percentage of the pension account will not change." },
            { "info": "7) It is assumed that the member will be entitled for a rebate of 15% of the taxable pension income." },
            { "info": "8) It is assumed that the member will contribute (including superannuation guarantee contribution\nand salary sacrifice) up to the maximum concessional contribution cap in a financial year." },
            { "info": "9) It is assumed that the net investment return in accumulation and pension phase take into the\nconsideration of the tax impact." },
        ];
